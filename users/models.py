...
class Project(models.Model):
    ...
    project_image = models.ImageField(upload_to=PathAndRename(image_path), default="Teensconnect.jpg")
...
class UserExtraDetails(models.Model):
    ...
    user_image = models.ImageField(upload_to=PathAndRename(image_path), default="avatar.jpg")
    ...
    def get_fields(self):
        return [(field.name, field.value_to_string(self)) for field in UserExtraDetails._meta.fields if
                field.name != 'user']
...
class ContactDetails(models.Model):
    ...
    def get_fields(self):
        return [(field.name, field.value_to_string(self)) for field in ContactDetails._meta.fields if
                field.name != 'user']
